...
Following \cite{Malcolm2021} and their \ac{lbd} Server, this thesis' prototype uses the \href{http://xeokit.io/index.html}{Xeokit SDK}, an \enquote{open source 3D graphics SDK from xeolabs for BIM and AEC.}\footcite{xeokit}. This \ac{sdk}
