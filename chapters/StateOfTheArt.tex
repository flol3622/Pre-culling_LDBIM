...
\begin{figure}[H]
    \begin{adjustwidth}{-0.8cm}{-0.8cm}
        ...
        \vspace{-0.3cm}
        \caption{Illustration of Level 1 (left) and Level 2 (right) of the \acs{fog} and \acs{omg} ontologies, based on \cite{Bonduel2019}. \textcolor{red}{LOD can't be assigned to literal, needs to be changed}}
        \label{fig:fogGom}
    \end{adjustwidth}
\end{figure}
...
\begin{figure}[H]
    \begin{adjustwidth}{-0.8cm}{-0.8cm}
        \centering
        \input{figures/diagrams/JohanssonPerformances.tex}
